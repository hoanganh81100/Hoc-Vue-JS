<template>
  <div id="app">
    <div class="container">
      ...
      <demo-slot>
        <!-- <div class="app-slot">
          <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed varius dolor sit amet euismod porttitor. Duis lobortis lacus et rhoncus congue. Sed neque diam, pharetra tempor elit nec, consectetur tempus diam.</p>
        </div> -->
      </demo-slot>
    </div>
  </div>
