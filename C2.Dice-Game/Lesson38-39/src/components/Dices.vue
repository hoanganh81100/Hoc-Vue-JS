...
.spinner .face3 {
  -webkit-transform: rotateX(90deg) rotateY(90deg) translateZ(60px);
  -ms-transform: rotateX(90deg) rotateY(90deg) translateZ(60px);
  transform: rotateX(90deg) rotateY(90deg) translateZ(60px);
